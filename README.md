...
This version introduces critical security hardening:

- **Axios Upgrade**: Updated to `v1.x` to patch known vulnerabilities.
- **SSRF Protection**: Requests are restricted to authorized Kkiapay endpoints.
- **DoS Prevention**: Request timeouts and size limits are now enforced.
